...
- (iRate *)init
{
	if ((self = [super init]))
	{
		...
		self.rateButtonLabel = NSLocalizedString(@"Rate It Now", @""); 
	}
	return self;
}
...
- (NSString *)messageTitle
{
	...
	return [NSString stringWithFormat:NSLocalizedString(@"Rate %@", @""), applicationName];
}
...
- (NSString *)message
{
	...
	return [NSString stringWithFormat:NSLocalizedString(@"If you enjoy using %@, would you mind taking a moment to rate it? It won't take more than a minute. Thanks for your support!", @""), applicationName];
}
